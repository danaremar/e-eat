...
<section id="wclp_content4" class="wclp_tab_section">
	<div class="d_table addons_page_dtable" style="">
		...
		<input id="tab_addons" type="radio" name="inner_tabs" class="wclp_tab_input" data-tab="addon" checked="">
		<label for="tab_addons" class="inner_tab_label"><?php _e( 'Add-ons', 'woo-advanced-shipment-tracking' ); ?></label>
		
		<input id="tab_license" type="radio" name="inner_tabs" class="wclp_tab_input" data-tab="addon">
