			...
			<div class="pickup-location-list">
				...
				<?php foreach( $data as $key => $location ) { ?>
                    ...
                    <div class="single-location"><div>
                        ...
                        <?php if($location_id == $location->id) { ?><span class="default-label"><?php _e( 'Default', 'woocommerce' ); ?></span><?php } ?>
						...
						<td class="button-column">
							<div class="submit wclp-btn">
								...
								<?php if(!class_exists( 'Advanced_local_pickup_PRO' )) { ?>
									...
									<p><?php _e( 'Need additional pickup locations?', 'advanced-local-pickup-for-woocommerce' ); ?><a href="https://www.zorem.com/product/advanced-local-pickup-for-woocommerce/?utm_source=wp-admin&utm_medium=ALPPRO&utm_campaign=add-ons" style="text-decoration: none;"><?php _e( ' Get to the Advanced Local Pickup Pro', 'advanced-local-pickup-for-woocommerce' ); ?></a></p>
								<?php } ?>
							</div>
						</td>
					</tr>
