...
class wclp_pickup_customizer_email {
	...
	*/
	...
	public static function is_own_customizer_request() {
		return isset( $_REQUEST['email'] ) && $_REQUEST['email'] === 'customer_pickup_email';
	}
	...
	*/
	...
	public function wclp_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		$wp_customize->add_setting( 'pickup_order_email_heading',
			array(
				'default' => '',
		...
		$wp_customize->add_control( new WPLP_Customize_Heading_Control( $wp_customize, 'pickup_order_email_heading',
			array(
				'label' => __( 'Picked up status email', 'advanced-local-pickup-for-woocommerce' ),
				'description' => __( 'This section lets you customize the Email Content.', 'advanced-local-pickup-for-woocommerce' ),
				'section' => 'customer_pickup_email'
			)
		) );		
		...
		$wp_customize->add_control( 'customizer_pickup_order_settings_enabled',
			array(
				'label' => __( 'Enable Picked up order status email', 'advanced-local-pickup-for-woocommerce' ),
		...
		// Preview Order		
		$wp_customize->add_setting( 'wclp_pickup_preview_order_id',
			array(
				'default' => 'mockup',
				'transport' => 'refresh',
				'sanitize_callback' => ''
		...
		$wp_customize->add_control( new WPLP_Skyrocket_Dropdown_Select_Custom_Control( $wp_customize, 'wclp_pickup_preview_order_id',
			array(
		...
		$wp_customize->add_control( 'woocommerce_customer_pickup_order_settings[subject]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wclp_pickup_email_subject'], 'advanced-local-pickup-for-woocommerce' ),
				),
			)
		);
		...
		$wp_customize->add_control( 'woocommerce_customer_pickup_order_settings[heading]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wclp_pickup_email_heading'], 'advanced-local-pickup-for-woocommerce' ),
				),
			)
		);
		...
		$wp_customize->add_control( new WPLP_Skyrocket_TinyMCE_Custom_control( $wp_customize, 'woocommerce_customer_pickup_order_settings[additional_content]',
			array(
				...
				'input_attrs' => array(
					...
					'mediaButtons' => true,
					'placeholder' => __( $this->defaults['wclp_pickup_email_content'], 'advanced-local-pickup-for-woocommerce' ),
				)
			)
		) );
